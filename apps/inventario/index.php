    ...
    <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-3">
        <?php if ($objetos->num_rows > 0): ?>
            <?php while($obj = $objetos->fetch_assoc()): 
                ...
                // Lógica de visualización de URL en el input (comprobación http)
                            ...
                            <div class="mb-2">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex gap-2 align-items-center">
                                        <input type="text" name="portada_http" id="txt_edit_obj_<?php echo $obj['id']; ?>" class="form-control form-control-sm" list="listaImagenesInventario" value="<?php echo htmlspecialchars($portada_input_val); ?>" oninput="updatePreview('preview_edit_obj_<?php echo $obj['id']; ?>', this.value)">
    ...
    <div class="row row-cols-2 row-cols-md-4 row-cols-lg-6 g-3">
        <?php if ($loc_paginadas->num_rows > 0): ?>
            <?php while($loc = $loc_paginadas->fetch_assoc()): 
                ...
                // Lógica de visualización de URL en localizaciones
                    ...
                    <form class="modal-content" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-2">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <div class="d-flex gap-2 align-items-center">
                                        <input type="text" name="foto_http" id="txt_edit_loc_<?php echo $loc['id']; ?>" class="form-control form-control-sm" list="listaImagenesInventario" value="<?php echo htmlspecialchars($foto_input_val); ?>" oninput="updatePreview('preview_edit_loc_<?php echo $loc['id']; ?>', this.value)">
